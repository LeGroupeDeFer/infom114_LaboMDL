        ...
        <Card className="mb-5">
          <Card.Body>
            <div className="text-center">
              <p>
                Unanimity est une plateforme collaborative de discussions et de prises de décision relative à l'UNamur.
              </p>

              <p>
                Vous en avez assez des  longues réunions et des chaînes de mails infinies qui ne semblent jamais aboutir à une décision ou à un résultat de groupe ?

                On dirait que vous avez besoin de UNanimity : une plateforme de collaboration qui transforme radicalement la façon dont les instances facultaires prennent des décisions, discutent des idées et collaborent.
                Dites adieu aux réunions fastidieuses et aux courriels qui encombrent votre boîte de réception et essayez gratuitement les outils de prise de décision de UNanimity !
        ...
        <Accordion>
            ...
            <Accordion.Collapse eventKey="2">
              <Card.Body>
                <p><b>Oui !</b> Certains modérateurs ont pour tâche de juger les idées
                  et permettre un suivi sur les plus pertinentes. Ce suivi pourra alors
          ...
          <Card>
            ...
            <Accordion.Collapse eventKey="3">
              <Card.Body>
                <p>L'algorithme suivant est utilisé pour donner une meilleure visibilité aux publications les plus pertinentes :</p>

                <code>// pseudocode</code><br/>
                <code>base = sqrt(2)</code><br/>
                <code>epoch = 01/01/2020</code><br/>
                <code>rank = log_sqrt(2) (votes) + (epoch - publication_date)</code>
                <p>
                  Avec
                  <ul>
                    <li>la variable <code>base</code> qui a été choisie de concert avec notre product owner.</li>
                    <li>la variable <code>epoch</code> est utilisée comme point de départ de l'application</li>
                  </ul>
                </p>
                <p>
                  De cette façon, les votes permettent de faire monter temporairement le ranking d'une publication.
                  En effet, après un certain temps, les nouvelles publications auront un <a href="https://www.youtube.com/watch?v=dQw4w9WgXcQ"><i>rank</i></a> équivalent aux vielles publications qui ont un haut score.
                </p>
                <p>
                  Avec les paramètres actuels, un post qui a 100 votes positifs arrivera à un <i>rank</i> équivalent à un post de 0 vote créé 15 jours plus tard.
                </p>
              </Card.Body>
            </Accordion.Collapse>
          </Card>
